...
LLM Agents ─── Multi-Agent Reasoning ─── RAG & Knowledge Systems
     │                   │
     └── Meta-Cognition  ── Controller Tuning ── MIMO Systems
                              │
                         Scientific Figures
                              │
...
| ⭐ | Repo | What it does |
|----|------|-------------|
| **63** | [Python60DaysChallenge](https://github.com/cheer932041235/Python60DaysChallenge) | Structured 60-day Python curriculum — fundamentals → ML projects, 2.1k forks |
| **21** | [api-proxy-server](https://github.com/cheer932041235/api-proxy-server) | Self-hosted AI API gateway · OpenAI / Claude / DeepSeek behind one endpoint |
| **4** | [FinAgent-RAG](https://github.com/cheer932041235/FinAgent-RAG) | Agentic RAG for financial document QA — planning, retrieval, reflection |
| **2** | [browser-automation-workbench](https://github.com/cheer932041235/browser-automation-workbench) | CDP-based browser automation — execution engine, workflow recorder, trace reviewer |
| **1** | [pybullet-robot-arm-tutorial](https://github.com/cheer932041235/pybullet-robot-arm-tutorial) | PyBullet + Franka Panda robot-arm tutorial · beginner to RL |
| — | [llm-control-performance-judgment-benchmark](https://github.com/cheer932041235/llm-control-performance-judgment-benchmark) | Simulator-grounded benchmark for LLM-as-controller judgment |
| — | [llm-onprem-control](https://github.com/cheer932041235/llm-onprem-control) | On-premise LLMs as structural priors for coupled MIMO controller tuning |
| — | [paper-review-system](https://github.com/cheer932041235/paper-review-system) | Two-tier LLM paper review committee · cross-consensus + venue calibration |
| — | [sci-figure-studio](https://github.com/cheer932041235/sci-figure-studio) | 13 matplotlib templates · 230 colormaps · top-venue figure gallery |
